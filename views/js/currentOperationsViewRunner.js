        ...
        if (worker === null) {
            ...
            worker.onmessage = async function (event) {
                if (event.data != false) {
                    ...
                    UI.createAlert(
                        'error',
                        'Communication with the system has been suddenly lost, trying to re-establish connection...',
                        10000,
                        'Clicked'
                    );
                }
...
const resetFile = function (id) {
    const i = _.findIndex(printers, function (o) { return o._id == id; });
        ...
        if (document.getElementById('currentOpCard-' + current.index)) {
            ...
            <div class="col-2 pt-0 pb-0" id="viewPanel-${current.index}">
              ...
              >
                  ...
                  <h6 id="currentFile-${current.index}" class="pb-0 text-center" style="font-size:0.6rem;"> ${current.fileName} </h6>
